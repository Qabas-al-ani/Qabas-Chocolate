			...
			<div className='relative mx-auto max-w-[1400px] px-6 pb-14 pt-16 lg:px-14'>
				...
				<div className='grid grid-cols-1 gap-12 md:grid-cols-[1.2fr_0.8fr_0.8fr_1.2fr]'>
					<div className='flex items-start'>
						<span className='inline-flex w-[210px] shrink-0 items-center justify-center rounded-lg bg-[#1b0805]/95 p-4 ring-1 ring-[#8f6634]/40 sm:w-[260px]'>
							<Image
								src='/logo-choco.png'
								alt='Qabas Chocolate logo'
								width={260}
								height={141}
					...
					<section aria-labelledby='footer-social'>
						...
						<div className='mt-4 flex items-center gap-3'>
							<SocialIcon label='GitHub' href='https://github.com/Qabas-al-ani'>
				...
				<div className='mt-10 border-t border-[#7e5a31]/40 pt-5 text-center text-sm text-[#d7bb8a]'>
					Copyright © {currentYear} Qabas Chocolate
				</div>
			</div>
		</footer>
	)
